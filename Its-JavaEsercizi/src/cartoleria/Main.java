...
public class Main {
	...
	public static void main(String[] args) {
		...
		// test privati e aziende
		Private p = new Private("mario", 200);
		p.paga(10);
		...
		Ordine o = new Ordine(d, a);
		
		// aggiungere merci
		
		o.aggiungiArticolo(gm2);
		o.aggiungiArticolo(pn1);
		
		
		System.out.println("Numero ordine: " + o.getNumero());
		System.out.println("Totale ordine: " + o.calcolaTotale());
