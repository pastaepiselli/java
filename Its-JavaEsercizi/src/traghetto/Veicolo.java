...
public abstract class Veicolo implements Tariffabile {
	...
	public Veicolo(String targa, int num_pers) throws IllegalAccessException{
		this.targa = targa;
		this.setNumPers(num_pers);
	...
	public void setNumPers(int num_pers) throws IllegalAccessException {
		if (num_pers <= 0 ) {
			throw new IllegalAccessException("num_pers non puo essere < 0");
		}
